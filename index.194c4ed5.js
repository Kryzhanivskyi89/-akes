...
return new w.fn.init(e,t)};function T(e){// Support: real iOS 8.2 only (not reproducible in simulator)
// `in` check used to prevent JIT error (gh-2145)
// hasOwn isn't used here due to false negatives
// regarding Nodelist length in IE
var t=!!e&&"length"in e&&e.length,n=E(e);return!(v(e)||m(e))&&("array"===n||0===t||"number"==typeof t&&t>0&&t-1 in e)}function H(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()}w.fn=w.prototype={// The current version of jQuery being used
...
// if not specified.
globalEval:function(e,t,n){x(e,{nonce:t&&t.nonce},n)},each:function(e,t){var n,r=0;if(T(e))for(n=e.length;r<n&&!1!==t.call(e[r],r,e[r]);r++);else for(r in e)if(!1===t.call(e[r],r,e[r]))break;return e},// Retrieve the text value of an array of DOM nodes
...
makeArray:function(e,t){var n=t||[];return null!=e&&(T(Object(e))?w.merge(n,"string"==typeof e?[e]:e):s.call(n,e)),n},inArray:function(e,t,n){return null==t?-1:u.call(t,e,n)},isXMLDoc:function(e){var t=e&&e.namespaceURI,n=e&&(e.ownerDocument||e).documentElement;// Assume HTML when documentElement doesn't yet exist, such as inside
// document fragments.
...
if(T(e))for(r=e.length;i<r;i++)null!=(o=t(e[i],i,n))&&s.push(o);else for(i in e)null!=(o=t(e[i],i,n))&&s.push(o);// Flatten any nested arrays
...
var q=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function N(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}w.escapeSelector=function(e){return(e+"").replace(q,N)},function(){var t,n,o,a,l,c,f,p,h,v,m=s,b=w.expando,x=0,E=0,C=ee(),S=ee(),T=ee(),q=ee(),N=function(e,t){return e===t&&(l=!0),0},_="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
...
// error in IE/Edge.
Y=function(){ea()},K=ec(function(e){return!0===e.disabled&&H(e,"fieldset")},{dir:"parentNode",next:"legend"});// Optimize for push.apply( _, NodeList )
...
N=function(e,t){// Flag for duplicate removal
...
l=!g.sortStable,a=!g.sortStable&&i.call(e,0),R.call(e,N),l){for(;t=e[o++];)t===e[o]&&(r=n.push(o));for(;r--;)j.call(e,n[r],1)}return(// Clear input after sorting to release objects
...
for(;(d=++f&&d&&d[h]||(y=f=0)||p.pop())&&(!((s?H(d,v):1===d.nodeType)&&++y)||(m&&((c=d[b]||(d[b]={}))[e]=[x,y]),d!==t)););return(// Incorporate the offset, then check against cycle size
...
var t=[],n=[],r=ep(e.replace(L,"$1"));return r[b]?et(function(e,t,n,o){// Match elements unmatched by `matcher`
...
return H(e,"input")&&!!e.checked||H(e,"option")&&!!e.selected},selected:function(e){return e.parentNode&&e.parentNode.selectedIndex,!0===e.selected},// Contents
...
header:function(e){return $.test(e.nodeName)},input:function(e){return W.test(e.nodeName)},button:function(e){return H(e,"input")&&"button"===e.type||H(e,"button")},text:function(e){var t;return H(e,"input")&&"text"===e.type&&// Support: IE <10 only
 ...
 * @param {String} type
 */function(e){return function(t){return H(t,"input")&&t.type===e}}(t);for(t in{submit:!0,reset:!0})n.pseudos[t]=/**
 * Returns a function to use in pseudos for buttons
 * @param {String} type
 */function(e){return function(t){return(H(t,"input")||H(t,"button"))&&t.type===e}}(t);// Easy API for creating new setFilters
...
type:o[0].replace(L," ")}),s=s.slice(r.length)),n.filter)(o=I[a].exec(s))&&(!l[a]||(o=l[a](o)))&&(r=o.shift(),i.push({value:r,type:a,matches:o}),s=s.slice(r.length));if(!r)break}return(// Return the length of the invalid excess
...
if(u){for(;t=t[r];)if((1===t.nodeType||a)&&e(t,n,u))return!0}else for(;t=t[r];)if(1===t.nodeType||a){if(c=t[b]||(t[b]={}),o&&H(t,o))t=t[r]||t;else{if((l=c[i])&&l[0]===x&&l[1]===s)return d[2]=l[2];// A match means we're done; a fail means we have to keep checking
if(// Reuse newcache so results back-propagate to previous elements
c[i]=d,d[2]=e(t,n,u))return!0}}return!1}}function ed(e){return e.length>1?function(t,n,r){for(var o=e.length;o--;)if(!e[o](t,n,r))return!1;return!0}:e[0]}function ef(e,t,n,r,o){for(var i,a=[],s=0,u=e.length,l=null!=t;s<u;s++)(i=e[s])&&(!n||n(i,r,o))&&(a.push(i),l&&t.push(s));return a}function ep(e,t/* Internal Use Only */){var r,i,a,s,l=[],d=[],f=T[e+" "];if(!f){for(t||(t=eu(e)),s=t.length;s--;)(f=function e(t){for(var r,i,a,s=t.length,l=n.relative[t[0].type],c=l||n.relative[" "],d=l?1:0,f=ec(function(e){return e===r},c,!0),p=ec(function(e){return u.call(r,e)>-1},c,!0),h=[function(e,t,n){// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
...
d=p.length;d--;)(f=p[d])&&(c=i?u.call(e,f):h[d])>-1&&(e[c]=!(a[c]=f))}}else p=ef(p===a?p.splice(v,p.length):p),i?i(null,a,p,l):m.apply(a,p)})}(d>1&&ed(h),d>1&&el(t.slice(0,d-1).concat({value:" "===t[d-2].type?"*":""})).replace(L,"$1"),i,d<a&&e(t.slice(d,a)),a<s&&e(t=t.slice(a)),a<s&&el(t))}h.push(i)}return ed(h)}(t[s]))[b]?l.push(f):d.push(f);// Save selector and tokenization
// Cache the compiled function
(f=T(e,(r=l.length>0,i=d.length>0,a=function(e,t,a,s,u){var f,h,g,v=0,y="0",b=e&&[],E=[],C=o,S=e||i&&n.find.TAG("*",u),T=x+=null==C?1:Math.random()||.1,H=S.length;// Add elements passing elementMatchers directly to results
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(o=t==c||t||u);y!==H&&null!=(f=S[y]);y++){if(i&&f){for(h=0,t||f.ownerDocument==c||(ea(f),a=!p);g=d[h++];)if(g(f,t||c,a)){m.call(s,f);break}u&&(x=T)}// Track unmatched elements for set filters
...
m.apply(s,E),u&&!e&&E.length>0&&v+l.length>1&&w.uniqueSort(s)}return u&&(x=T,o=C),b},r?et(a):a))).selector=e}return f}/**
...
// Sort stability
g.sortStable=b.split("").sort(N).join("")===b,// Initialize against the default document
...
o(e.contentDocument)?e.contentDocument:(H(e,"template")&&(e=e.content||e),w.merge([],e.childNodes))}},function(e,t){w.fn[e]=function(n,r){var o=w.map(this,t,n);return"Until"!==e.slice(-5)&&(r=n),r&&"string"==typeof r&&(o=w.filter(r,o)),this.length>1&&(J[e]||w.uniqueSort(o),V.test(e)&&o.reverse()),this.pushStack(o)}});var I=/[^\x20\t\r\n\f]+/g;function W(e){return e}function $(e){throw e}function z(e,t,n,r){var o;try{// Check for promise aspect first to privilege synchronous behavior
...
for(i=0;i<a;i++)null!=o[i]&&(e[i].style.display=o[i]);return e}w.fn.extend({show:function(){return ey(this,!0)},hide:function(){return ey(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){eg(this)?w(this).show():w(this).hide()})}});var eb=/^(?:checkbox|radio)$/i,ex=/<([a-z][^\/\0>\x20\t\r\n\f]*)/i,eE=/^$|^module$|\/(?:java|ecma)script/i;e6=y.createDocumentFragment().appendChild(y.createElement("div")),// Support: Android 4.0 - 4.3 only
// Check state lost if the name is set (trac-11217)
// Support: Windows Web Apps (WWA)
// `name` and `type` must use .setAttribute for WWA (trac-14901)
(e5=y.createElement("input")).setAttribute("type","radio"),e5.setAttribute("checked","checked"),e5.setAttribute("name","t"),e6.appendChild(e5),// Support: Android <=4.1 only
// Older WebKit doesn't clone checked state correctly in fragments
g.checkClone=e6.cloneNode(!0).cloneNode(!0).lastChild.checked,// Support: IE <=11 only
// Make sure textarea (and checkbox) defaultValue is properly cloned
e6.innerHTML="<textarea>x</textarea>",g.noCloneChecked=!!e6.cloneNode(!0).lastChild.defaultValue,// Support: IE <=9 only
// IE <=9 replaces <option> tags with their contents when inserted outside of
// the select element.
e6.innerHTML="<option></option>",g.option=!!e6.lastChild;// We have to close these tags to support XHTML (trac-13200)
...
var n;return(n=void 0!==e.getElementsByTagName?e.getElementsByTagName(t||"*"):void 0!==e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&H(e,t))?w.merge([e],n):n}// Mark scripts as having already been evaluated
function ew(e,t){for(var n=0,r=e.length;n<r;n++)eo.set(e[n],"globalEval",!t||eo.get(t[n],"globalEval"))}eC.tbody=eC.tfoot=eC.colgroup=eC.caption=eC.thead,eC.th=eC.td,g.option||(eC.optgroup=eC.option=[1,"<select multiple='multiple'>","</select>"]);var eT=/<|&#?\w+;/;function eH(e,t,n,r,o){for(var i,a,s,u,l,c=t.createDocumentFragment(),d=[],f=0,p=e.length;f<p;f++)if((i=e[f])||0===i){// Add nodes directly
if("object"===E(i))// push.apply(_, arraylike) throws on ancient WebKit
w.merge(d,i.nodeType?[i]:i);else if(eT.test(i)){for(a=a||c.appendChild(t.createElement("div")),s=eC[(ex.exec(i)||["",""])[1].toLowerCase()]||eC._default,a.innerHTML=s[1]+w.htmlPrefilter(i)+s[2],// Descend through wrappers to the right content
...
return eb.test(t.type)&&t.click&&H(t,"input")&&eL(t,"click",!0),!1},trigger:function(e){// For mutual compressibility with _default, replace `this` access with a local var.
// `|| data` is dead code meant only to preserve the variable through minification.
var t=this||e;// Return non-false to allow normal event-path propagation
return eb.test(t.type)&&t.click&&H(t,"input")&&eL(t,"click"),!0},// For cross-browser consistency, suppress native .click() on links
// Also prevent it if we're currently inside a leveraged native-event stack
_default:function(e){var t=e.target;return eb.test(t.type)&&t.click&&H(t,"input")&&eo.get(t,"click")||H(t,"a")}},beforeunload:{postDispatch:function(e){// Support: Firefox 20+
...
eL(this,e,!0),!y.documentMode)return!1;// Support: IE 9 - 11+
...
eL(this,e),!0)},teardown:function(){var e;if(!y.documentMode)return!1;(e=eo.get(this,t)-1)?eo.set(this,t,e):(this.removeEventListener(t,n),eo.remove(this,t))},// Suppress native focus or blur if we're currently inside
...
eq=/<script|<style|<link/i,eN=/checked\s*(?:[^=]|=\s*.checked.)/i,e_=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
function eP(e,t){return H(e,"table")&&H(11!==t.nodeType?t:t.firstChild,"tr")&&w(e).children("tbody")[0]||e}// Replace/restore the type attribute of script elements for safe DOM manipulation
...
if(m||f>1&&"string"==typeof h&&!g.checkClone&&eN.test(h))return e.each(function(o){var i=e.eq(o);m&&(t[0]=h.call(this,o,i.html())),eU(i,t,n,r)});if(f&&(i=(o=eH(t,e[0].ownerDocument,!1,e,r)).firstChild,1===o.childNodes.length&&(o=i),i||r)){// Use the original fragment for the last item
...
(a=a.replace(L,"$1")||void 0),""!==a||ep(e)||(a=w.style(e,t)),!g.pixelBoxStyles()&&eV.test(a)&&eW.test(t)&&(// Remember the original values
...
!g.reliableTrDimensions()&&H(e,"tr")||// Fall back to offsetWidth/offsetHeight when value is "auto"
...
w.fx.step={};var e6,e5,e9,e7,e8=/^(?:toggle|show|hide)$/,te=/queueHooks$/;// Animations created synchronously will run synchronously
...
!n.disabled&&(!n.parentNode.disabled||!H(n.parentNode,"optgroup"))){// We don't need an array for one selects
...
return this.name&&!w(this).is(":disabled")&&tS.test(this.nodeName)&&!tC.test(e)&&(this.checked||!eb.test(e))}).map(function(e,t){var n=w(this).val();return null==n?null:Array.isArray(n)?w.map(n,function(e){return{name:t.name,value:e.replace(tE,"\r\n")}}):{name:t.name,value:n.replace(tE,"\r\n")}}).get()}});var tw=/%20/g,tT=/#.*$/,tH=/([?&])_=[^&]*/,tk=/^(.*?):[ \t]*([^\r\n]*)$/mg,tR=/^(?:GET|HEAD)$/,tj=/^\/\//,/* Prefilters
	 ...
	 */tL={},tq="*/".concat("*"),tN=y.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
function tP(e,t,n,r){var o={},i=e===tL;function a(s){var u;return o[s]=!0,w.each(e[s]||[],function(e,s){var l=s(t,n,r);return"string"!=typeof l||i||o[l]?i?!(u=l):void 0:(t.dataTypes.unshift(l),a(l),!1)}),u}return a(t.dataTypes[0])||!o["*"]&&a("*")}// A special extend for ajax options
// that takes "flat" options (not to be deep extended)
// Fixes trac-9887
function tD(e,t){var n,r,o=w.ajaxSettings.flatOptions||{};for(n in t)void 0!==t[n]&&((o[n]?e:r||(r={}))[n]=t[n]);return r&&w.extend(!0,e,r),e}tN.href=tg.href,w.extend({// Counter for holding the number of active queries
...
ajaxSetup:function(e,t){return t?tD(tD(e,w.ajaxSettings),t):tD(w.ajaxSettings,e)},ajaxPrefilter:t_(tA),ajaxTransport:t_(tL),// Main method
...
abort:function(e){var t=e||C;return r&&r.abort(t),T(0,t),this}};// A cross-domain request is in order when the origin doesn't match the current origin.
if(// Attach deferreds
...
u.href=u.href,p.crossDomain=tN.protocol+"//"+tN.host!=u.protocol+"//"+u.host}catch(e){// If there is an error parsing the URL, assume it is crossDomain,
...
o=p.url.replace(tT,""),p.hasContent?p.data&&p.processData&&0===(p.contentType||"").indexOf("application/x-www-form-urlencoded")&&(p.data=p.data.replace(tw,"+")):(// Remember the hash so we can put it back
...
delete p.data),!1===p.cache&&(o=o.replace(tH,"$1"),f=(tm.test(o)?"&":"?")+"_="+tv.guid+++f),// Put hash and anti-cache on the URL that will be requested (gh-1732)
...
r=tP(tL,p,n,S)){// If request was aborted inside ajaxSend, stop there
if(S.readyState=1,c&&g.trigger("ajaxSend",[S,p]),l)return S;p.async&&p.timeout>0&&(s=e.setTimeout(function(){S.abort("timeout")},p.timeout));try{l=!1,r.send(x,T)}catch(e){// Rethrow post-completion exceptions
if(l)throw e;// Propagate others as results
T(-1,e)}}else T(-1,"No Transport");// Callback for when everything is done
function T(t,n,a,u){var d,f,y,x,E,C=n;// Ignore repeat invocations
...
(r=(t=y.implementation.createHTMLDocument("")).createElement("base")).href=y.location.href,t.head.appendChild(r)):t=y),o=F.exec(e),i=!n&&[],o)?[t.createElement(o[1])]:(o=eH([e],t,i),i&&i.length&&w(i).remove(),w.merge([],o.childNodes))},/**
...
}),m()}function m(){h.style.transform="translate(-"+g*a+"px)"}window.addEventListener("resize",v),v(),document.querySelector(".slider-next").addEventListener("click",function(){++g>=p.length&&(g=0),m()}),document.querySelector(".slider-prev").addEventListener("click",function(){--g<0&&(g=p.length-1),m()});var y=document.querySelector(".submit"),b=document.querySelector(".form"),x=document.querySelector(".ok_message"),E=document.querySelector(".btn-close");document.querySelector(".order-btn").addEventListener("click",function(){b.classList.add("active")}),y.addEventListener("click",function(){y.parent().parent().hide(300),x.classList.add("active")}),E.addEventListener("click",function(){console.log("poc"),b.classList.remove("active")}),x.addEventListener("click",function(){x.classList.remove("active");//   form.classList.remove("active").show();
});var C={};C=c("aNJCr").getBundleURL("EVgbq")+"1desk@1x.5703d9b4.jpg";var S={};S=c("aNJCr").getBundleURL("EVgbq")+"1tab@1x.673653b2.jpg";var w={};w=c("aNJCr").getBundleURL("EVgbq")+"1mob@1x.69785b6f.jpg";var T={};T=c("aNJCr").getBundleURL("EVgbq")+"2desk@1x.96833ea4.jpg";var H={};H=c("aNJCr").getBundleURL("EVgbq")+"2tab@1x.fe3ecb27.jpg";var k={};k=c("aNJCr").getBundleURL("EVgbq")+"2mob@1x.ede91e6f.jpg";var R={};R=c("aNJCr").getBundleURL("EVgbq")+"3desk@1x.6d1f071d.jpg";var j={};j=c("aNJCr").getBundleURL("EVgbq")+"3tab@1x.9ee26a87.jpg";var A={};A=c("aNJCr").getBundleURL("EVgbq")+"3mob@1x.6bd378f8.jpg";var L={};L=c("aNJCr").getBundleURL("EVgbq")+"4desk@1x.345a1318.jpg";var q={};q=c("aNJCr").getBundleURL("EVgbq")+"4tab@1x.cf493627.jpg";var N={};N=c("aNJCr").getBundleURL("EVgbq")+"4mob@1x.2afe27c2.jpg";var _={};_=c("aNJCr").getBundleURL("EVgbq")+"5desk@1x.6181253e.jpg";var P={};P=c("aNJCr").getBundleURL("EVgbq")+"5tab@1x.d3bf8586.jpg";var D={};D=c("aNJCr").getBundleURL("EVgbq")+"5mob@1x.33de1c8f.jpg";var F={};F=c("aNJCr").getBundleURL("EVgbq")+"6desk@1x.22c4d2ad.jpg";var B={};B=c("aNJCr").getBundleURL("EVgbq")+"6tab@1x.b1cfdde8.jpg";var U={};U=c("aNJCr").getBundleURL("EVgbq")+"6mob@1x.4ca7edf6.jpg";var O={};O=c("aNJCr").getBundleURL("EVgbq")+"7desk@1x.bd263f1b.jpg";var V={};V=c("aNJCr").getBundleURL("EVgbq")+"7tab@1x.3cc9ea70.jpg";var J={};J=c("aNJCr").getBundleURL("EVgbq")+"7mob@1x.f672273d.jpg";var M={};M=c("aNJCr").getBundleURL("EVgbq")+"8desk@1x.0fe487a9.jpg";var I={};I=c("aNJCr").getBundleURL("EVgbq")+"8tab@1x.fa92e96a.jpg";var W={};W=c("aNJCr").getBundleURL("EVgbq")+"8mob@1x.ada5ba30.jpg";var $={};$=c("aNJCr").getBundleURL("EVgbq")+"9desk@1x.3627d42f.jpg";var z={};z=c("aNJCr").getBundleURL("EVgbq")+"9tab@1x.78c3aa74.jpg";var X={};X=c("aNJCr").getBundleURL("EVgbq")+"9mob@1x.9c41dce6.jpg";var Q={};Q=c("aNJCr").getBundleURL("EVgbq")+"10desk@1x.bf93d187.jpg";var G={};G=c("aNJCr").getBundleURL("EVgbq")+"10tab@1x.bc96d452.jpg";var Y={};Y=c("aNJCr").getBundleURL("EVgbq")+"10mob@1x.5c2e3975.jpg";var K={};K=c("aNJCr").getBundleURL("EVgbq")+"11desk@1x.016fce68.jpg";var Z={};Z=c("aNJCr").getBundleURL("EVgbq")+"11tab@1x.cedb6327.jpg";var ee={};ee=c("aNJCr").getBundleURL("EVgbq")+"11mob@1x.72753896.jpg";var et={};et=c("aNJCr").getBundleURL("EVgbq")+"12desk@1x.ab64a7f3.jpg";var en={};en=c("aNJCr").getBundleURL("EVgbq")+"12tab@1x.a6cc30bb.jpg",c("aNJCr").getBundleURL("EVgbq");var er={};er=c("aNJCr").getBundleURL("EVgbq")+"13desk@1x.dbe006b3.jpg";var eo={};eo=c("aNJCr").getBundleURL("EVgbq")+"13tab@1x.409b8dde.jpg";var ei={};ei=c("aNJCr").getBundleURL("EVgbq")+"13mob@1x.d7b3fe15.jpg";var ea={};ea=c("aNJCr").getBundleURL("EVgbq")+"1desk@2x.5703d9b4.jpg";var es={};es=c("aNJCr").getBundleURL("EVgbq")+"1tab@2x.673653b2.jpg";var eu={};eu=c("aNJCr").getBundleURL("EVgbq")+"1mob@2x.69785b6f.jpg";var el={};el=c("aNJCr").getBundleURL("EVgbq")+"2desk@2x.8c19d163.jpg";var ec={};ec=c("aNJCr").getBundleURL("EVgbq")+"2tab@2x.18bde6d7.jpg";var ed={};ed=c("aNJCr").getBundleURL("EVgbq")+"2mob@2x.6f894f8f.jpg";var ef={};ef=c("aNJCr").getBundleURL("EVgbq")+"3desk@2x.c58e2d86.jpg";var ep={};ep=c("aNJCr").getBundleURL("EVgbq")+"3tab@2x.5b680e31.jpg";var eh={};eh=c("aNJCr").getBundleURL("EVgbq")+"3mob@2x.f34a86fa.jpg";var eg={};eg=c("aNJCr").getBundleURL("EVgbq")+"4desk@2x.967ef7e1.jpg";var ev={};ev=c("aNJCr").getBundleURL("EVgbq")+"4tab@2x.a2fd7cc6.jpg";var em={};em=c("aNJCr").getBundleURL("EVgbq")+"4mob@2x.eaaaa84d.jpg";var ey={};ey=c("aNJCr").getBundleURL("EVgbq")+"5desk@2x.d42ed89e.jpg";var eb={};eb=c("aNJCr").getBundleURL("EVgbq")+"5tab@2x.efacb099.jpg";var ex={};ex=c("aNJCr").getBundleURL("EVgbq")+"5mob@2x.e176f762.jpg";var eE={};eE=c("aNJCr").getBundleURL("EVgbq")+"6desk@2x.fefc695a.jpg";var eC={};eC=c("aNJCr").getBundleURL("EVgbq")+"6tab@2x.51635a43.jpg";var eS={};eS=c("aNJCr").getBundleURL("EVgbq")+"6mob@2x.5df99d17.jpg";var ew={};ew=c("aNJCr").getBundleURL("EVgbq")+"7desk@2x.e64cb8f6.jpg";var eT={};eT=c("aNJCr").getBundleURL("EVgbq")+"7tab@2x.84e640e3.jpg";var eH={};eH=c("aNJCr").getBundleURL("EVgbq")+"7mob@2x.90eaadbf.jpg";var ek={};ek=c("aNJCr").getBundleURL("EVgbq")+"8desk@2x.af305e8d.jpg";var eR={};eR=c("aNJCr").getBundleURL("EVgbq")+"8tab@2x.7a0607cf.jpg";var ej={};ej=c("aNJCr").getBundleURL("EVgbq")+"8mob@2x.ac4ff740.jpg";var eA={};eA=c("aNJCr").getBundleURL("EVgbq")+"9desk@2x.600598e0.jpg";var eL={};eL=c("aNJCr").getBundleURL("EVgbq")+"9tab@2x.d69c0800.jpg";var eq={};eq=c("aNJCr").getBundleURL("EVgbq")+"9mob@2x.5198122d.jpg";var eN={};eN=c("aNJCr").getBundleURL("EVgbq")+"10desk@2x.6e9ab827.jpg";var e_={};e_=c("aNJCr").getBundleURL("EVgbq")+"10tab@2x.00d99014.jpg";var eP={};eP=c("aNJCr").getBundleURL("EVgbq")+"10mob@2x.e4aef60c.jpg";var eD={};eD=c("aNJCr").getBundleURL("EVgbq")+"11desk@2x.be416a78.jpg";var eF={};eF=c("aNJCr").getBundleURL("EVgbq")+"11tab@2x.ac7bf444.jpg";var eB={};eB=c("aNJCr").getBundleURL("EVgbq")+"11mob@2x.89239162.jpg",c("aNJCr").getBundleURL("EVgbq"),c("aNJCr").getBundleURL("EVgbq");var eU={};eU=c("aNJCr").getBundleURL("EVgbq")+"12mob@2x.c4f0f812.jpg",c("aNJCr").getBundleURL("EVgbq"),c("aNJCr").getBundleURL("EVgbq"),c("aNJCr").getBundleURL("EVgbq");var eO=[{id:1,deskPhoto:/*@__PURE__*/e(C),tabPhoto:/*@__PURE__*/e(S),mobPhoto:/*@__PURE__*/e(w),deskPhoto2x:/*@__PURE__*/e(ea),tabPhoto2x:/*@__PURE__*/e(es),mobPhoto2x:/*@__PURE__*/e(eu),// photo: desk1x1,
// photo2x: g1x2,
title:"Misha",alt:"tort dlya Mishy",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:2,deskPhoto:/*@__PURE__*/e(T),tabPhoto:/*@__PURE__*/e(H),mobPhoto:/*@__PURE__*/e(k),deskPhoto2x:/*@__PURE__*/e(el),tabPhoto2x:/*@__PURE__*/e(ec),mobPhoto2x:/*@__PURE__*/e(ed),// photo: g2,
title:"",alt:"",description:"July 2023"},{id:3,deskPhoto:/*@__PURE__*/e(R),tabPhoto:/*@__PURE__*/e(j),mobPhoto:/*@__PURE__*/e(A),deskPhoto2x:/*@__PURE__*/e(ef),tabPhoto2x:/*@__PURE__*/e(ep),mobPhoto2x:/*@__PURE__*/e(eh),// photo: g3,
title:"",alt:"",description:"July 2023"},{id:4,deskPhoto:/*@__PURE__*/e(L),tabPhoto:/*@__PURE__*/e(q),mobPhoto:/*@__PURE__*/e(N),deskPhoto2x:/*@__PURE__*/e(eg),tabPhoto2x:/*@__PURE__*/e(ev),mobPhoto2x:/*@__PURE__*/e(em),// photo: g4,
title:"",alt:"",description:"July 2023"},{id:5,deskPhoto:/*@__PURE__*/e(_),tabPhoto:/*@__PURE__*/e(P),mobPhoto:/*@__PURE__*/e(D),deskPhoto2x:/*@__PURE__*/e(ey),tabPhoto2x:/*@__PURE__*/e(eb),mobPhoto2x:/*@__PURE__*/e(ex),// photo: g5,
title:"",alt:"",description:"July 2023"},{id:6,deskPhoto:/*@__PURE__*/e(F),tabPhoto:/*@__PURE__*/e(B),mobPhoto:/*@__PURE__*/e(U),deskPhoto2x:/*@__PURE__*/e(eE),tabPhoto2x:/*@__PURE__*/e(eC),mobPhoto2x:/*@__PURE__*/e(eS),// photo: g6,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:7,deskPhoto:/*@__PURE__*/e(O),tabPhoto:/*@__PURE__*/e(V),mobPhoto:/*@__PURE__*/e(J),deskPhoto2x:/*@__PURE__*/e(ew),tabPhoto2x:/*@__PURE__*/e(eT),mobPhoto2x:/*@__PURE__*/e(eH),// photo: g7,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:8,deskPhoto:/*@__PURE__*/e(M),tabPhoto:/*@__PURE__*/e(I),mobPhoto:/*@__PURE__*/e(W),deskPhoto2x:/*@__PURE__*/e(ek),tabPhoto2x:/*@__PURE__*/e(eR),mobPhoto2x:/*@__PURE__*/e(ej),// photo: g8,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:9,deskPhoto:/*@__PURE__*/e($),tabPhoto:/*@__PURE__*/e(z),mobPhoto:/*@__PURE__*/e(X),deskPhoto2x:/*@__PURE__*/e(eA),tabPhoto2x:/*@__PURE__*/e(eL),mobPhoto2x:/*@__PURE__*/e(eq),// photo: g9,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:10,deskPhoto:/*@__PURE__*/e(Q),tabPhoto:/*@__PURE__*/e(G),mobPhoto:/*@__PURE__*/e(Y),deskPhoto2x:/*@__PURE__*/e(eN),tabPhoto2x:/*@__PURE__*/e(e_),mobPhoto2x:/*@__PURE__*/e(eP),// photo: g10,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:11,deskPhoto:/*@__PURE__*/e(K),tabPhoto:/*@__PURE__*/e(Z),mobPhoto:/*@__PURE__*/e(ee),deskPhoto2x:/*@__PURE__*/e(eD),tabPhoto2x:/*@__PURE__*/e(eF),mobPhoto2x:/*@__PURE__*/e(eB),// photo: g11,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:12,deskPhoto:/*@__PURE__*/e(et),tabPhoto:/*@__PURE__*/e(en),mobPhoto:/*@__PURE__*/e(eU),// deskPhoto2x: desk12x2,
// tabPhoto2x: tab12x2,
// mobPhoto2x: mob12x2,
// photo: g12,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"},{id:13,deskPhoto:/*@__PURE__*/e(er),tabPhoto:/*@__PURE__*/e(eo),mobPhoto:/*@__PURE__*/e(ei),// deskPhoto2x: desk13x2,
// tabPhoto2x: tab13x2,
// mobPhoto2x: mob13x2,
// photo: g13,
title:"",alt:"",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cum cumque minus iste veritatis providentat"}],eV={gallery:document.querySelector(".container__gallery")};function eJ(e,t,n,r,o,i,a){try{var s=e[i](a),u=s.value}catch(e){n(e);return}s.done?t(u):Promise.resolve(u).then(r,o)}console.log(eO),r=eO.map(function(e){var t=e.id,n=e.deskPhoto,r=e.deskPhoto2x,o=e.tabPhoto,i=e.tabPhoto2x,a=e.mobPhoto,s=e.mobPhoto2x,u=e.alt,l=e.title,c=e.description;return'        \n            <li class="card" key='.concat(t,'>                \n                \n                    <div class="face face1">\n                        <div class="content">\n                            <picture>\n                                <source srcset="\n                                    ').concat(n," 1x, \n                                    ").concat(r,' 2x"\n                                    media="(min-width:1200px)"/>\n                                <source srcset="\n                                    ').concat(o," 1x, \n                                    ").concat(i,' 2x" \n                                    media="(min-width:768px)"/>\n                                <source srcset="\n                                    ').concat(a," 1x, \n                                    ").concat(s,' 2x" \n                                    media="(max-width:767px)"/>\n                                <img\n                                    src=').concat(n," \n                                    alt=").concat(u,' \n                                    width="250" \n                                    height="200" \n                                    loading="lazy"\n                                    sizes="226.8046875px"\n                                />\n                            </picture>\n                        </div>\n                    </div>\n                    <div class="face face2">\n                        <div class="content">\n                            <h3>').concat(l,"</h3>\n                            <p>").concat(c,"</p>\n                        </div>\n                    </div>\n                 \n            </li>        \n        ")}).join(""),eV.gallery.insertAdjacentHTML("beforeend",r),"function"==typeof SuppressedError&&SuppressedError,document.getElementById("contactForm").addEventListener("submit",(o=function(e){var t,n,r,o;return function(e,t){var n,r,o,i,a={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return i={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(i[Symbol.iterator]=function(){return this}),i;function s(s){return function(u){return function(s){if(n)throw TypeError("Generator is already executing.");for(;i&&(i=0,s[0]&&(a=0)),a;)try{if(n=1,r&&(o=2&s[0]?r.return:s[0]?r.throw||((o=r.return)&&o.call(r),0):r.next)&&!(o=o.call(r,s[1])).done)return o;switch(r=0,o&&(s=[2&s[0],o.value]),s[0]){case 0:case 1:o=s;break;case 4:return a.label++,{value:s[1],done:!1};case 5:a.label++,r=s[1],s=[0];continue;case 7:s=a.ops.pop(),a.trys.pop();continue;default:if(!(o=(o=a.trys).length>0&&o[o.length-1])&&(6===s[0]||2===s[0])){a=0;continue}if(3===s[0]&&(!o||s[1]>o[0]&&s[1]<o[3])){a.label=s[1];break}if(6===s[0]&&a.label<o[1]){a.label=o[1],o=s;break}if(o&&a.label<o[2]){a.label=o[2],a.ops.push(s);break}o[2]&&a.ops.pop(),a.trys.pop();continue}s=t.call(e,a)}catch(e){s=[6,e],r=0}finally{n=o=0}if(5&s[0])throw s[1];return{value:s[0]?s[1]:void 0,done:!0}}([s,u])}}}(this,function(i){switch(i.label){case 0:e.preventDefault(),t=e.target,n=new FormData(t),r="https://cakes-backend.onrender.com",console.log(o={}),n.forEach(function(e,t){o[t]=e}),i.label=1;case 1:return i.trys.push([1,3,,4]),[4,fetch("".concat(r,"/orders"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)})];case 2:return i.sent().ok?alert("Заказ успішно надіслано!"):alert("Сталася помилка при надсиланні заказу."),[3,4];case 3:return console.error("Помилка:",i.sent()),alert("Сталася помилка при надсиланні заказу."),[3,4];case 4:return[2]}})},i=function(){var e=this,t=arguments;return new Promise(function(n,r){var i=o.apply(e,t);function a(e){eJ(i,n,r,a,s,"next",e)}function s(e){eJ(i,n,r,a,s,"throw",e)}a(void 0)})},function(e){return i.apply(this,arguments)})),document.addEventListener("DOMContentLoaded",function(){var e=document.querySelectorAll(".about-item");console.log(e);var t=new IntersectionObserver(function(e){e.forEach(function(e){e.isIntersecting?e.target.classList.add("visible"):e.target.classList.remove("visible")})},{threshold:.1});e.forEach(function(e){t.observe(e)})})}();//# sourceMappingURL=index.194c4ed5.js.map

//# sourceMappingURL=index.194c4ed5.js.map
